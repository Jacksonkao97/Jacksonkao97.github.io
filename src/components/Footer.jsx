...
export default function Footer() {
  return (
    <footer className="bg-background border-border/40 w-full border-t">
      <div className="container mx-auto flex p-4 sm:px-0">
        <p className="text-muted-foreground self-center font-mono text-xs md:text-sm">
          &copy; {new Date().getFullYear()} Jackson Kao. All rights reserved.
        </p>
